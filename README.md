...
The Movie Recommendation System is a console-based application developed in C++ that allows users to explore, search, and receive movie recommendations based on genres and categories.
...
The purpose of this project is to simulate a simple recommendation engine using fundamental programming concepts instead of advanced AI models.

It focuses on:

- Organizing movie data efficiently
  
- Providing filtered search options
  
- Generating recommendations based on similarity (genre)
  
- Applying core DSA concepts in a real application
